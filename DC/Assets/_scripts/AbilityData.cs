...
public class AbilityData : MonoBehaviour
{
	...
	protected static Sprite TryGetBuffIcon(string _name)
	{
	...
	{
		public delegate IEnumerator FunctionToCall(TargetData inputData); //System.Func<System.Collections.IEnumerator> function;
