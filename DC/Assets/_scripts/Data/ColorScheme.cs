...
{
	public static Color activeAbilityColor = new Color(0,0,0.35f);
	public static Color inactiveAbilityColor = new Color(0.3f,0.3f,0.3f);
	public static Color playerTurnTextColor = new Color(0.8f,0.4f,0);
