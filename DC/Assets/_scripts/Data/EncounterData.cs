...
{   /* 	/----------------------------\
	...
	*///\----------------------------/
	...
	public static StatBlock urnEnvironmentBlock = new StatBlock(StatBlock.Race.Construct, "Urn",				001, 000,		00, 0, 00, 00, 00, 00, new List<Ability> { wobble }, _aiType: StatBlock.AIType.Dumb, _drops: DropTable.environmentUrnDrop);
	public static StatBlock stalagmiteEnvironmentBlock = new StatBlock(StatBlock.Race.Construct, "Stalagmite",	002, 000,		00, 0, 00, 00, 00, 00, new List<Ability> { wobble }, _aiType: StatBlock.AIType.Dumb, _baseDefense: 1, _drops: DropTable.environmentStalagmiteDrop);
	...
	public static StatBlock poisionousSpider = new StatBlock(StatBlock.Race.Animal, "Poisionous Spider",		005, 008,		03, 0, 02, 02, 03, 02, new List<Ability> { poison }, _aiType: StatBlock.AIType.Dumb, _drops: DropTable.poisionousSpiderDrop);
	...
	public static StatBlock guardianBlock = new StatBlock(StatBlock.Race.Human, "Guardian",						020, 020,		05, 0, 05, 04, 01, 03, new List<Ability> { forcePunch, magicShield }, _aiType: StatBlock.AIType.Smart, _baseDefense: 1, _drops: DropTable.guardianDrop);
	public static StatBlock giantBlock = new StatBlock(StatBlock.Race.Human, "Giant",							030, 000,		05, 0, 08, 04, 01, 01, new List<Ability> { punch }, _aiType: StatBlock.AIType.Dumb, _baseDefense: 1, _drops: DropTable.giantDrop);
	public static StatBlock deathSpider = new StatBlock(StatBlock.Race.Animal, "Death Spider",					015, 018,		05, 0, 04, 03, 05, 03, new List<Ability> { poison, poisonBite }, _immunities: Elementals.Poison, _aiType: StatBlock.AIType.Dumb, _drops: DropTable.deathSpiderDrop);
	...
	public static StatBlock stoneGolemBlock = new StatBlock(StatBlock.Race.Construct, "Stone Golem",			045, 010,		06, 0, 06, 02, 01, 01, new List<Ability> { doubleKick, bulkUp, hardenSkin }, _weaknesses: Elementals.Water, _immunities: Elementals.Light, _aiType: StatBlock.AIType.Dumb, _baseDefense: 2, _drops: DropTable.stoneGolemDrop);
	public static StatBlock steelGolemBlock = new StatBlock(StatBlock.Race.Construct, "Steel Golem",			060, 010,		08, 0, 10, 04, 03, 01, new List<Ability> { doubleKick, bulkUp, hardenSkin }, _weaknesses: Elementals.Water | Elementals.Electricity, _immunities: Elementals.Light | Elementals.Poison, _aiType: StatBlock.AIType.Dumb, _baseDefense: 4, _baseMagicDefense: -1, _drops: DropTable.steelGolemDrop);
	...
	public static StatBlock goldGolemBlock = new StatBlock(StatBlock.Race.Construct, "Gold Golem",				075, 030,		10, 0, 15, 05, 08, 03, new List<Ability> { doubleKick, bulkUp, hardenSkin, fireball }, _immunities: Elementals.Light | Elementals.Poison, _aiType: StatBlock.AIType.Smart, _baseDefense: 6, _baseMagicDefense: -2, _drops: DropTable.goldGolemDrop);
	#endregion
