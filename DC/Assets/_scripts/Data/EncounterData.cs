...
{   /* 	/----------------------------\
	...
	*///\----------------------------/
	...
	public static StatBlock steelGolemBlock = new StatBlock(StatBlock.Race.Construct, "Steel Golem",			060, 010,		08, 0, 10, 04, 03, 01, new List<Ability> { doubleKick, bulkUp, hardenSkin }, _weaknesses: Elementals.Water | Elementals.Electricity, _immunities: Elementals.Light | Elementals.Poison, _aiType: StatBlock.AIType.Dumb, _defense: 4, _magicDefense: -1, _drops: DropTable.steelGolemDrop);
	...
	public static StatBlock goldGolemBlock = new StatBlock(StatBlock.Race.Construct, "Gold Golem",				075, 030,		10, 0, 15, 05, 08, 03, new List<Ability> { doubleKick, bulkUp, hardenSkin, fireball }, _immunities: Elementals.Light | Elementals.Poison, _aiType: StatBlock.AIType.Smart, _defense: 6, _magicDefense: -2, _drops: DropTable.goldGolemDrop);
	#endregion
